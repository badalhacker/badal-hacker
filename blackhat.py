...
logo = """
  ...
  \033[1;91m:》》》\033[1;93m+9779804963643\033[1;91m《《《▒▒▒▒▒▒▒▒▒▒▒:::::
...
\033[1;94mWhatsapp\033[1;91m: \033[1;91m+9779804963643
\033[1;95m♡╰──────────•◈•──────────╯♡\033[1;96mBlackMafia\033[1;95m♡╰──────────•◈•──────────╯♡"""
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:Blackhat_hacker
	    time.sleep(2)
            loop = 'false'
        else:
...
def menu():
	...
	try:
		...
		keluar()
	os.system("clear") #Dev:Blackhat_hacker
	print logo
...
def pilih_super():
	...
	p.map(main, id)
	print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mBlackMafia\033[1;95m♡──────────•◈•──────────♡"
	print "  \033[1;93m«---•◈•---Developed By love---•◈•---»" #Dev:Blackhat_hacker
	...
	print """
             ...
             ◥⊙▲⊙▲⊙▲⊙▲⊙▲⊙◤
♡──────────────•◈•──────────────♡.
: \033[1;96m .....lovehacker  Blackhat........... \033[1;93m :
♡──────────────•◈•──────────────♡.' 
                Mobile Num
               +9779804963643"""
